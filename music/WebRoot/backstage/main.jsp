				...
				<div class="panel-body" >
					<table class="table table-hover personal-task">
                         <tbody>
                         	<tr>
                         		<td>
                         			<strong>版本信息</strong>： 版本名称：<a href="JavaScript:void(0)">JSFiction</a> 版本号: K01_2019_01
                         	...
                         	<tr>
                         		<td>
                                <strong>服务器IP</strong>：172.168.0.01
                                </td>
                                <td></td>
                         	</tr>
                         	<tr>
                         		<td>
                                <strong>服务器环境</strong>：正常
                                </td>
                                <td></td>
                         	</tr>
                         	<tr>
                         		<td>
                                <strong>数据库版本</strong>： Oracle
                         	...
                         	<tr>
                         		<td>
                                <strong>当前登录用户</strong>：${juser.uname }<!--  <span class="current_user">未定义</span> -->
          ...
          <!-- 系统公告 -->
             <section class="panel">
                 <header class="panel-heading bm0">
                  ...
                  <div class="panel-body">
                        <table class="table">
                        	<c:forEach items="${JnovelSum[4] }" var="entity">
                        		<tr>
                        			<td>${entity.messagecontext }</td>
                        		</tr>
                        	</c:forEach>
                        </table>
                  </div>
